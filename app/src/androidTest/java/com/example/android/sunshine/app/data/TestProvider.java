...
//Make sure we can still delete after adding/updating stuff
    ...
    // Make sure we can still delete after adding/updating stuff Student:Uncomment this test after you have completed writing the delete
    // functionality in your provider.It relies on insertions with testInsertReadProvider, so insert and query functionality must also
    // be complete before this test can be used.
